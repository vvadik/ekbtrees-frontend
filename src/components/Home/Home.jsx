    ...
    return (
      <section className={cn([styles.green, styles.getStart, styles.desktop])}>
        ...
        <div className={styles.getStartRight}>
          <a className={styles.logInDesktop} exact to='/login' activeclassname="active">Войти</a>
          <a className={styles.signUpDesktop} exact to='/registration' activeclassname="active">Зарегистрироваться</a>
        </div>
      </section>
    )
  }
