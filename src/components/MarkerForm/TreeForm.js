...
export const TreeForm = ({activeTree, setActiveTree }) => {
    return (
        <div className= {activeTree ? "tree-form-container active" : "tree-form-container"} onClick={() => setActiveTree(null)}>
            {activeTree &&
                <figure class="tree-form-main" onClick={e => e.stopPropagation()}>
                    ...
                    <form>
                            ...
                            <div>
                                ...
                                <label>
                                    <input required type="text" disabled value = {activeTree.treePlantingType}/>
                                </label>
                            </div>
                    </form>
                </figure>}
